...
import { DashboardSnapshot, OrderRequest, TradeProposal } from "../shared/types";

export type AssistantIntent =
  | { kind: "answer"; answer: string }
  | { kind: "analysis"; answer: string; proposal?: TradeProposal };

export class VscodeLlmProvider {
  async interpret(question: string, snapshot: DashboardSnapshot): Promise<AssistantIntent> {
...
async function collectText(parts: AsyncIterable<string>): Promise<string> {
  let text = "";
