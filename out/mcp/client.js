...
exports.VscodeMcpBinanceClient = void 0;
const vscode = __importStar(require("vscode"));
class VscodeMcpBinanceClient {
    async getSnapshot() {
...
exports.VscodeMcpBinanceClient = VscodeMcpBinanceClient;
...
function estimateValueUsd(balance, markets) {
    const amount = balance.free + balance.locked;
    if (amount <= 0)
        return 0;
    if (["USDT", "USDC", "BUSD"].includes(balance.asset))
        return amount;
